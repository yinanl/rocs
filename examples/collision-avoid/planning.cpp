 ...
 *  planning.cpp
 *
 *  Generate a global plan for a planar vehicle to satisfy a DBA
...
int main(int argc, char *argv[])
{
    ...
    double obs[4][4] = {
	{1.6+5, 5.7+5, 4.0+5, 5.0+5},
	{3.0+5, 5.0+5, 5.0+5, 8.0+5},
    ...
    /* Compute abstraction */
    float tabst;
    std::string transfile = "abstfull2_0.2-0.2-0.2.h5";
    struct stat buffer;
     ...
     */
    double goal[3][4] = {{1.0+3, 2.0+3, 0.5+3, 2.0+3},
    ...
    std::string datafile = "controller2_" + tokens[0] + "_";
    for(int i = 0; i < 3; ++i) {
	std::stringstream ss;
    ...
    // std::string winfile = "graph_winning.h5";
