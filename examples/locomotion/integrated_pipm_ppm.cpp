/**
 *  integrated_pipm_ppm.cpp
 *  
 *  One walking step from PIPM to PPM:
...
const double ds2 = 0.04;
const double dz2 = 0.003;

const double zeta_r1[] = {0.05, 10}; // zeta boundaries for robust tube intersection
...
int main()
{
    ...
    const std::string prefix = "integrated/pipm2ppm/data_integrate_pipm2ppm_q";
    ...
    WalkStep step2("semi2", tau, n, m, PPM, loc2);
    ...
    /* Save grids */
    rocs::matWriter wtr("integrated/pipm2ppm/data_grids_pipm2ppm.mat");
    wtr.open();
