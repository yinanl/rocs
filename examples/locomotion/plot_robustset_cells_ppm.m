function plot_robustset_cells_ppm(N1,N2,xpos,ds,dz,omega,x,Dx,x0,z0)
% FUNCTION
% -----------
% plot the partition of a robust margin set for PPM mode
%
% INPUT
% -----------
...
%         plot(xpl, zlp, '-', 'Color', CP(5,:), 'LineWidth', LThin)
        ...
        rbleft= zbdl(vul(:,2)<=zlp & zlp<=vll(:,2),:);
        rbright= zbdu(vuu(:,2)<=zup & zup<=vlu(:,2),:);
