...
% 
% plot_robustset_cells_mcm(N1,N2,xpos,ds1,dz1,omega1,x1,zeta_0,zmin,'right');
% plot_robustset_cells_pipm(N1,N3,xpos,ds2,dz2,omega2,x2,Dx,x2_0,zeta_0);
% 
% % % format display
% axis(axBase, 'square')
...
%% simulating cells
load('integrated/mcm2pipm/data_grids_mcm2pipm.mat');

prefix= 'integrated/mcm2pipm/data_integrate_mcm2pipm_q';
midfix= '_p';
suffix= '.mat';
