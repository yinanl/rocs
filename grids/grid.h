...
class grid {
 ...
 public:
   ...
   */
  void write2txt_data(const char* filename);
  
  /**
   * Save grid data to .mat file.
   * @param filename the saved file name.
   * @param varname the saved variable name (appearred in matlab).
   */
  void write2mat_data(const char* filename, const char* varname);
